...
# ============ Load Data ============
df = pd.read_csv("../data/Software_Salaries.csv")  # Adjust path if needed
...
if best_name == "RandomForest":
    ...
    print("SHAP is only available for RandomForest in this setup.")
